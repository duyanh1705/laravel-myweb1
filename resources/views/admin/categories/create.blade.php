        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3 img-group">
                    ...
                    <!-- Nơi chứa ảnh preview tự động bung lên khi chọn file -->
            ...
            <div class="mb-3">
                <label class="form-label font-weight-bold">Mô tả loại sản phẩm</label>
                <textarea name="description" rows="3" class="form-control" placeholder="Nhập mô tả chi tiết...">{{ old('description') }}</textarea>
                @error('description')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
